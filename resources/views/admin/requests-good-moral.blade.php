...
@section('title', 'Good Moral Requests')
...
<div class="bg-gradient-to-r from-[#760000] to-[#D62F26] text-white rounded-xl p-8 mb-8 shadow-lg">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold mb-2">Good Moral Requests</h1>
            <p class="text-gray-100">View and manage all good moral certificate requests</p>
        </div>
...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    <form method="GET" action="{{ route('admin.requests.good-moral') }}" class="space-y-4">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.requests.good-moral') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 font-medium">
                Clear
            </a>
        </div>
    </form>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center text-gray-400">
                        ...
                        <p class="text-lg">No good moral requests found.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
