...
<body class="h-screen w-screen flex">
    ...
    <div id="privacyModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-3xl shadow-2xl w-[480px] overflow-hidden">
            <div class="p-8 text-center">
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('images/LoginSticker.png') }}" alt="Privacy" class="w-80">
                </div>

                <p class="text-gray-700 text-base leading-relaxed mb-6">
                    By continuing to use the <strong>Student Portal</strong>, you agree to the
                    <a href="https://www.usep.edu.ph/usep-data-privacy-statement/" target="_blank" class="text-[#C85A54] font-semibold hover:underline">University of Southeastern Philippines' Data Privacy Statement</a>.
                </p>

                <button onclick="acceptPrivacy()"
                    class="w-full bg-[#C85A54] text-white font-medium py-3 rounded-full text-base hover:bg-[#B04A44] transition-all">
                    CONTINUE
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        function closePrivacyModal() {
            // Only allow closing if user clicks outside or presses X (but we want them to click "I Understand")
            alert('Please click "I Understand" to continue.');
        }
