            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="college" name="college" required
                        ...
                        <option value="College of Information and Computing" {{ old('college') === 'College of Information and Computing' ? 'selected' : '' }}>College of Information and Computing</option>
