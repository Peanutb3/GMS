...
<div class="max-w-4xl mx-auto py-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 p-8">
        <div class="flex items-start gap-6">
            <div class="relative flex-shrink-0">
                ...
                <a href="{{ route('osas-du.profile.edit') }}" title="Edit avatar" class="absolute -bottom-1 -right-1 bg-white rounded-full p-2.5 shadow-md border-2 border-gray-200 hover:bg-gray-50 transition">
            ...
            <div class="flex-1 pt-2">
                <div class="flex items-start justify-between">
                    ...
                    <button onclick="window.location.href='{{ route('osas-du.profile.edit') }}'" class="px-4 py-2 bg-gradient-to-r from-red-900 to-red-800 text-white text-sm font-medium rounded-lg hover:from-red-800 hover:to-red-700 transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            <a href="{{ route('osas-du.profile.edit') }}" class="flex items-center justify-between gap-4 px-6 py-4 hover:bg-gray-50">
            ...
            <a href="{{ route('osas-du.change-password') }}" class="flex items-center justify-between gap-4 px-6 py-4 hover:bg-gray-50">
