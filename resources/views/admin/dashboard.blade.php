            ...
            <div class="flex items-center justify-between">
                ...
                <div class="bg-purple-100 p-3 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="6" r="4"/><path d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5"/>
                    </svg>
                </div>
            </div>
        </div>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-gray-700">{{ $grievance->program_snapshot }}</td>
                            <td class="px-4 py-3">
